def run_shock_simulation(user_input):
    ...
    if export_restriction:
        trade_shock *= 1.3  #Export bans should amplify the shock value
    ...
    exchange_pass_through = 0.75  # assuming partial hedging
    currency_shock = (
        currency_volatility *
        import_cost_share *
    ...
    if base_shock_score > 50:
        base_shock_score *= 1.15  # Crisis should amplify
